/*
Task:2
Create an AVL Tree using insertion sequence as { 55, 66, 77, 11, 33, 22, 35, 25, 44, 88,99 }, the
program should print the height of tree too.
*/
#include<iostream>
using namespace std;
#define spaces 10
...
int main(){
    ...
    cout<<endl<<"The height of AVL tree is: "<<obj.height(obj.root);
